...
namespace PursuitHQ.API.DTOs.Students
{
    ...
    public class ConversationSummaryDto
    {
        ...
        /// <summary>Everyone still in it, for avatars and the members list.</summary>
    ...
    public class CreateGroupDto
    {
        ...
        /// <summary>
        /// Everyone to add besides the creator. Each one must be a connection -
        /// checked server side, because a group is otherwise a way to put a
        /// message in front of someone who never accepted you.
        /// </summary>
