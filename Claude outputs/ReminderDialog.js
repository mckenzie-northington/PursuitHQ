    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/40 p-4 sm:items-center">
      ...
      >
        ...
        <div className="space-y-4 px-5 py-4">
          {/*
            A normal labelled field, not the big borderless title the event
            dialog uses. That one carries a form with a dozen controls under it;
            over three fields it just reads as oversized.
          */}
          <div>
